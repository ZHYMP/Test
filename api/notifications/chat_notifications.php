...
// Handle GET request - Fetch document notifications for chat (exclude announcements)
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    // Only fetch document-related notifications (success, error, warning)
    // Exclude 'info' type which are announcements
    $query = "
        SELECT 
        ...
        WHERE n.user_id = ? 
        AND n.type IN ('success', 'error', 'warning')
