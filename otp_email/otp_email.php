...
<body>
    ...
    <div class="right">
        ...
        switch($purpose) {
            case 'signup':
                $purposeMessage = 'We\'ve sent a 6-digit OTP to your email to verify your account.';
                break;
            case 'forgot':
                $purposeMessage = 'We\'ve sent a 6-digit OTP to your email to reset your password.';
                break;
            case 'login':
            default:
...
<script src="otp_email.js"></script>
